...
import random
U=0;li=[];O=0;le=[];max=0;p=0;li2=[];le2=[];lg=[];fi=0
#======================================
def salir():
    for x in range(49):
        global max
...
def disparar(z):
    ...
    for x in range(49):
        ...
        if le2[x]==4:
            gan=gan+1
    lbl.configure(text="Pantalla de ataque: "+str(max-gan)+"/10")
    lbl1.configure(text="Pantalla de barcos: "+str(10-per)+"/10")
    ...
    if fi==1:
        ...
        vf.mainloop()
def partida():
    global li,le,li2,le2,lg,max,vf,lbl,lbl1,per,gan,fi
    li=[];le=[];li2=[];le2=[];lg=[];max=0;per=0;fi=0;gan=0
    for x in range(49):
        le.append(0)
    ...
    lbl.configure(text="Pantalla de ataque:"+"10"+"/10")
    w=0
    while w<10:
        w=w+1
...
#============================"barcos(P2)"=======================================================
lbl=tk.Label(v1,text="Pantalla de ataque 10/10",font=("Arial",18))
